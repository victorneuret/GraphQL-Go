...
func (ec *executionContext) field_Mutation_createArticle_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewArticle2githubᚗcomᚋvictorneuretᚋgraphqlᚑgoᚋgraphᚋmodelᚐNewArticle(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Article_text(ctx context.Context, field graphql.CollectedField, obj *model.Article) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_createArticle(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNArticle2ᚖgithubᚗcomᚋvictorneuretᚋgraphqlᚑgoᚋgraphᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_articles(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Article)
	fc.Result = res
	return ec.marshalNArticle2ᚕᚖgithubᚗcomᚋvictorneuretᚋgraphqlᚑgoᚋgraphᚋmodelᚐArticleᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNArticle2githubᚗcomᚋvictorneuretᚋgraphqlᚑgoᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v model.Article) graphql.Marshaler {
	return ec._Article(ctx, sel, &v)
}

func (ec *executionContext) marshalNArticle2ᚕᚖgithubᚗcomᚋvictorneuretᚋgraphqlᚑgoᚋgraphᚋmodelᚐArticleᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Article) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNArticle2ᚖgithubᚗcomᚋvictorneuretᚋgraphqlᚑgoᚋgraphᚋmodelᚐArticle(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNArticle2ᚖgithubᚗcomᚋvictorneuretᚋgraphqlᚑgoᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *model.Article) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNNewArticle2githubᚗcomᚋvictorneuretᚋgraphqlᚑgoᚋgraphᚋmodelᚐNewArticle(ctx context.Context, v interface{}) (model.NewArticle, error) {
